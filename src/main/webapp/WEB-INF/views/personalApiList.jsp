			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a id="personalListLink">Personal List</a></li>
				...
				<table id="apiTable" class="table col-xs-7">
					<thead>
						<tr>
							...
							<td class="pull-right">
								<div class="row">
									<button class="btn btn-success col-xs-2" data-toggle="modal"
								...
								<td colspan=3>
									<div class="container">
										...
										<div class="row detailRow">
											...
											<div class="col-lg-2">
												<a href="/APIHealthCheck/details/${globalViewData.id}"
			...
			.ready(
					function() {
						...
						if (c.length > 0) {
							...
							window.location.replace("/APIHealthCheck/login/");
						}
		...
		$.ajax({
			...
			complete : function(data) {
				if (data.responseJSON != null) {
					...
					var personalApi = {};
					personalApi["personId"] = cookie.id;
					personalApi["apiId"] = api.id;
					$.ajax({
						type : "POST",
						contentType : "application/json",
						'url' : "/APIHealthCheck/savePA",
						data : JSON.stringify(personalApi),
						dataType : 'json',
						complete : function(data) {
							if (data.responseJSON != null) {
